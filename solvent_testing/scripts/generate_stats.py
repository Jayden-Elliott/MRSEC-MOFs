...
def main(feature):
    ...
    for name, split in splits:
        ...
        for model in models:
            ...
            mae_sum = 0
            for run in runs:
                df = pd.read_csv(f"/Users/jayden/Documents/Code/MOFS_MRSEC/solvent_testing/predictions/{feature}_{name}_{run}.csv")
    ...
    r2_df.to_csv(f"/Users/jayden/Documents/Code/MOFS_MRSEC/solvent_testing/r2_scores/{feature}.csv", index=False)
    mae_df.to_csv(f"/Users/jayden/Documents/Code/MOFS_MRSEC/solvent_testing/mae_scores/{feature}.csv", index=False)
